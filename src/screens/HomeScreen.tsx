  ...
  return (
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <Pressable
          style={({ pressed }) => [styles.secondaryButton, pressed && styles.buttonPressed]}
          onPress={() => navigation.navigate("EatOutRecommendation")}
        >
          <Text style={styles.secondaryButtonText}>Where should I eat?</Text>
        </Pressable>
        ...
        >
          <Text style={styles.secondaryButtonText}>Your preferences</Text>
        </Pressable>
