...
export default function LoginScreen({ navigation }: any) {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      // On success, the root navigator (see App.tsx) switches to Home
      // automatically once `user` is set - no manual navigation needed.
    } catch (e) {
      setLocalError(e instanceof Error ? e.message : "Couldn't log in. Try again.");
    } finally {
      setSubmitting(false);
    }
  }
  ...
  return (
    ...
    >
      <View style={styles.content}>
        <Text style={styles.title}>Fit Your Macros</Text>
        <Text style={styles.subtitle}>Log in to keep tracking.</Text>
